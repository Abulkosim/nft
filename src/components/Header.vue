<template>
  <div class="h-14 container px-7 mx-auto flex justify-between items-center lg:h-24 select-none">
    ...
    <div class="flex items-center">
      <div class="tracking-wide hidden lg:flex lg:items-center lg:gap-1.5">
        ...
        <a href="#" class="flex items-center gap-2 py-4 px-5 bg-purple rounded-[20px] hover:bg-darker-purple">
